...
USERAGENTS = {
    ...
    'Mozilla Firefox / Mac OS X':
        'Mozilla/5.0 (Macintosh; Intel Mac OS X 12.5; rv:102.0) '
...
# taken from https://gist.github.com/gitkodak/b9c253e89397335356b13b37985778f5
ERRORS = {
    0: "",
    ...
    4: "A feature or option that was needed to perform "
       "the desired request was not enabled "
       "or was explicitly disabled at build-time. "
       "To make curl able to do this, "
    ...
    9: "FTP access denied. "
       "The server denied login or denied access to the particular resource "
       "or directory you wanted to reach. "
       "Most often you tried to change to a directory "
    ...
    11: "FTP weird PASS reply. "
        "Curl couldn't parse the reply sent to the PASS request.",
    12: "During an active FTP session "
        "while waiting for the server to connect back to curl, "
        "the timeout expired.",
    13: "FTP weird PASV reply, "
        "Curl couldn't parse the reply sent to the PASV request.",
    ...
    19: "FTP couldn't download/access the given file, "
        "the RETR (or similar) command failed.",
    21: "FTP quote error. A quote command returned error from the server.",
    22: "HTTP page not retrieved. "
        "The requested url was not found "
        "or returned another error "
    ...
    25: "FTP couldn't STOR file. "
        "The server denied the STOR operation, "
        "used for FTP uploading.",
    26: "Read error. Various reading problems.",
    27: "Out of memory. A memory allocation request failed.",
    28: "Operation timeout. "
        "The specified time-out period was reached "
    ...
    48: "Unknown option specified to libcurl. "
        "This indicates that you passed a weird option to curl "
        "that was passed on to libcurl and rejected. "
